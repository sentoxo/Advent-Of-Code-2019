...
with open(file='day07/input.txt', mode='r') as file:
    ...
    for i in range(3125):
        ...
        amp1 = intcodeCPU(code.copy(), (int(i%5)+5, 0))
        amp2 = intcodeCPU(code.copy(), (int(i%25/5)+5, amp1))
        amp3 = intcodeCPU(code.copy(), (int(i%125/25)+5, amp2))
        amp4 = intcodeCPU(code.copy(), (int(i%625/125)+5, amp3))
        amp5 = intcodeCPU(code.copy(), (int(i/625)+5, amp4))
